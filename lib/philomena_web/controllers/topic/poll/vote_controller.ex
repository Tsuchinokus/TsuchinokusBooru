defmodule TsuchinokusWeb.Topic.Poll.VoteController do
  ...
  plug TsuchinokusWeb.FilterBannedUsersPlug when action in [:create]
  plug TsuchinokusWeb.CanaryMapPlug, index: :show, create: :show, delete: :show
