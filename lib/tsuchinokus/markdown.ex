defmodule Tsuchinokus.Markdown do
  @markdown_chars ~r/[\*_\[\]\(\)\^`\%\\~<>#\|]/
  ...
  def to_html(text, replacements), do: Tsuchinokus.Native.markdown_to_html(text, replacements)
  ...
  def to_html_unsafe(text, replacements),
    do: Tsuchinokus.Native.markdown_to_html_unsafe(text, replacements)
